...
public class Trabalho_sem_proteção {
    public static void main(String[] args) throws InterruptedException{
        ...
        int total_votos = 20000000; // Total de votos por Urna

        Urna urna_eletronica = new Urna(0, 0, 0);
        Eleitor Eleitor1 = new Eleitor(total_votos, urna_eletronica);
        Eleitor Eleitor2 = new Eleitor(total_votos, urna_eletronica);
        Eleitor Eleitor3 = new Eleitor(total_votos, urna_eletronica);
        ...
        System.out.println("Total de votos esperado: " + 3*total_votos);
        System.out.println("Total de votos obtido: " + votos_totais);
        if (votos_totais == 3*total_votos) {
